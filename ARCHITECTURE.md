...
- `notes`: per-user, optionally per-slide free-text notes
...
4. Command broadcasting:
   - Via a `COMMAND` message: `NEXT_SLIDE` / `PREVIOUS_SLIDE` / `JUMP_TO_SLIDE`
...
Global headers via `frontend/next.config.js`:
